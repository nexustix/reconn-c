...
typedef enum {
  ...
  /*02*/ RECONN_ELEMENT_RESERVED,
  /*03*/ RECONN_ELEMENT_BIGNUM,
  /*04*/ RECONN_ELEMENT_I8,
  /*05*/ RECONN_ELEMENT_I16,
  /*06*/ RECONN_ELEMENT_I32,
  /*07*/ RECONN_ELEMENT_U8,
  /*08*/ RECONN_ELEMENT_U16,
  /*09*/ RECONN_ELEMENT_U32,
  /*10*/ RECONN_ELEMENT_WORD_PRIMARY,
  /*11*/ RECONN_ELEMENT_WORD_SECONDARY,
  /*12*/ RECONN_ELEMENT_ENUM,
  /*13*/ RECONN_ELEMENT_CSTRING,
} ReconnElementKind;
